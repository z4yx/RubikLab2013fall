...
int Turn_R()
{
	...
	up[0][2]=back[0][2];up[1][2]=back[1][2];up[2][2]=back[2][2];
...
int Turn_D()
{
	...
	front[0][0]=right[0][0];front[0][1]=right[2][1];front[0][2]=right[0][2];
...
int Turn_F()
{
	...
	up[0][0]=left[0][2];up[0][1]=left[1][2];up[0][2]=left[2][2];
	left[0][2]=down[2][0];left[1][2]=down[2][1];left[2][2]=down[2][2];
...
int Turn_B()
{
	...
	left[0][0]=down[0][0];left[1][0]=down[0][1];left[2][0]=down[0][2];
	down[0][0]=right[0][2];down[0][1]=right[0][2];down[0][2]=right[2][2];
